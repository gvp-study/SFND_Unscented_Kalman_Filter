...
public:
  ...
  std::vector<bool> trackCars = {true,true,true};//{true,false,false};//
		   ...
		   pcl::visualization::PCLVisualizer::Ptr& viewer)
  {
    if(visualize_pcd)
    {
      ...
      trafficCloud = tools.loadPcd("../src/sensors/data/pcd/highway_"+std::to_string(timestamp)+".pcd");
